...
from models.AE_OC.trainer.trainer import Trainer
from models.AE_OC.network.model import base_Model
...
exec(f'from conf.ae_oc.{data_type}_Configs import Config as Configs')
configs = Configs()
