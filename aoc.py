...
from models.AOC.trainer.trainer import Trainer
from models.AOC.network.model import base_Model
...
exec(f'from conf.aoc.{data_type}_Configs import Config as Configs')
configs = Configs()
